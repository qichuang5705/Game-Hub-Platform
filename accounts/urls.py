...
urlpatterns = [
    ...
    path('reset_password/', auth_views.PasswordResetView.as_view(template_name="password_reset.html", form_class=CustomPasswordResetForm), name="reset_password"),
    ...
    path('errortruycap/', views.ErrorTruyCap, name="errortruycap"),
]
